...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------------+-------------+-------------+-------------+-------------+--------|                    |----+-------------+-------------+-------------+-------------+--------|
     LSFT_T(KC_TAB), LGUI_T(KC_A), LALT_T(KC_R), LSFT_T(KC_S), LCTL_T(KC_T),    KC_G,                     KC_M, RCTL_T(KC_N), RSFT_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O),  KC_ENT,
  //|--------------+-------------+-------------+-------------+-------------+--------|                    |----+-------------+-------------+-------------+-------------+--------|
  ...
  //|-------+---------------+---------------+----------------+----------------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                 OSM_RGUI, OSM_LALT,          MO(_ADDONS),                  _______,  _______,  _______
                                 //`-----+---------+---------------------'  `----------------------+---------+---------'
  ),
