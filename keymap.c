...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+-------------+-------------+-------------+-------------+--------|                    |----+-------------+-------------+-------------+-------------+--------|
     CW_TOGG,         KC_Z,         KC_X,         KC_C,         KC_D,    KC_V,                     KC_K,         KC_H,      KC_COMM,       KC_DOT,      KC_SLSH, XXXXXXX,
  //|-------+-------------+-------------+-------------+-------------+--------+--------|  |--------+----+-------------+-------------+-------------+-------------+--------|
                                             _______,   KC_GRV,  LT(_SYMBOLS, KC_SPC),    LT(_NAVIGATION, KC_SPC), _______, _______
                                          //`-------+---------+----------------------'   `-----------------------+--------+--------'
  ),
  ...
  //|------+--------+--------+--------+--------+--------|                    |--------+----------------+----------------+----------------+--------+--------|
    XXXXXXX, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, XXXXXXX,                      KC_LBRC, RCTL_T(KC_RBRC), RSFT_T(KC_BSLS), RALT_T(KC_QUOT), KC_RGUI, XXXXXXX,
  //|------+--------+--------+--------+--------+--------|                    |--------+----------------+----------------+----------------+--------+--------|
  ...
  //|-------+---------------+---------------+----------------+----------------+--------|                    |--------+----------------+--------------+----------------+----------------+--------|
     XXXXXXX,        XXXXXXX,         KC_HOME,        KC_PGDN,         KC_PGUP,  KC_END,                      KC_MS_L,         KC_MS_D,       KC_MS_U,         KC_MS_R,         KC_WH_D, XXXXXXX,
  //|-------+---------------+---------------+----------------+----------------+--------+--------|  |--------+--------+----------------+--------------+----------------+----------------+--------|
                                                                   _______, _______,     _______,   _______,  _______,  _______
                                                                 //`------+--------+------------'   `------+---------+---------'
  )
